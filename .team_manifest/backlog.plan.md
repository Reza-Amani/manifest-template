...
- [ ] _(example)_ Stream large provider pages in the example subsystem (see
  [`example-subsystem.ref.md`](../.local_manifest/reference/example-subsystem.ref.md)).

## Active Context

- **Primary goal:** What the current focus is.
- **Related simple work:** Top-level plan, e.g.
  [`example-feature.planning.md`](../.local_manifest/plans/example-feature.planning.md).
- **Related epic:** Link to its master roadmap, e.g.
  [`example-epic.master.md`](../.local_manifest/plans/example-epic/example-epic.master.md).
