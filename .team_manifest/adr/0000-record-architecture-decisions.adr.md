...
Decision Record (ADR)** — a short Markdown file in [`adr/`](./).
...
- Agents can read [`routing.rule.md`](../rules/routing.rule.md) to
...
- Folder conventions: [`manifest-structure.rule.md`](../rules/manifest-structure.rule.md).
