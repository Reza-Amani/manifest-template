...
When the user later applies the manifest template, `apply-manifest-template`
merges the repo-type ignore rules from the canonical manifest layout guide.
