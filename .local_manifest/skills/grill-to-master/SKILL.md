...
description: >-
  ...
  plannable phases under `.local_manifest/plans/<epic>/`. The master plan has no
...
Use `<target>/.local_manifest/plans/<epic>/<epic>-initial.md` as the source of truth for
...
```text
.local_manifest/plans/<epic>/<epic>.master.md
```
